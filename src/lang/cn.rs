...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("ID", "ID"),
        ("Grid View", "网格视图"),
        ("account_expires_in_days", "您的账户将在 {} 天后到期。请联系管理员续期。"),
        ("account_expires_in_hours", "您的账户将在 {} 小时后到期。请联系管理员续期。"),
        ("account_expires_in_minutes", "您的账户将在 {} 分钟后到期。请保存工作并立即联系管理员。"),
        ("Account Expiry Warning", "账户到期警告"),
        ("Critical Warning", "紧急警告"),
        ("Account Expired", "账户已到期"),
        ("Account Disabled", "账户已禁用"),
        ("Your account has expired. You will be automatically logged out.", "您的账户已到期。系统将自动退出登录。"),
        ("Your account has been disabled. Please contact your administrator.", "您的账户已被禁用。请联系管理员。"),
