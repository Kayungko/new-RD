...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Grid View", "Grid view"),
        ("List View", "List view"),
        ("account_expires_in_days", "Your account will expire in {} days. Please contact your administrator to renew."),
        ("account_expires_in_hours", "Your account will expire in {} hours. Please contact your administrator to renew."),
        ("account_expires_in_minutes", "Your account will expire in {} minutes. Please save your work and contact your administrator immediately."),
        ("Account Expiry Warning", "Account Expiry Warning"),
        ("Critical Warning", "Critical Warning"),
        ("Account Expired", "Account Expired"),
        ("Account Disabled", "Account Disabled"),
        ("Your account has expired. You will be automatically logged out.", "Your account has expired. You will be automatically logged out."),
